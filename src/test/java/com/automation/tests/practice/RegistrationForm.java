...
public class RegistrationForm {
    ...
    public void test1(){
        ...
        @Test(description = "verify userName cant accept character less than 2 more than 64")
        public void test2(){
        ...
        @Test (description = "verify username rejects just numerical characters")
        public void verifyUsernameIsAlphabetical(){
        driver.findElement(firstNameBy).sendKeys("123456789");
        BrowserUtils.wait(2);
        WebElement message=driver.findElement(By.xpath("//small[text()='first name can only consist of alphabetical letters']"));
